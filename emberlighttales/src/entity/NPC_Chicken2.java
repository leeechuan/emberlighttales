...
public class NPC_Chicken2 extends Entity {
	
	public static final String npcName = "Cluckles McGee";
	public boolean caught = false;
	
	public NPC_Chicken2(GamePanel gp) {
		super(gp);
        ...
        if(!gp.qManager.getQuestJournal().getCompletedQuests().contains(gp.qManager.getQuestJournal().getQuestByName("Cluck and Dagger"))&&
				...
				gp.qManager.getQuestJournal().getQuestByName("Cluck and Dagger").getCurrentStageIndex() < 2) {
        	worldX = 64 * gp.tileSize;
        	worldY = 76 * gp.tileSize;
        }
        else {
        	worldX = 77 * gp.tileSize;
