...
public class OBJ_SmallTorch extends Entity{
	
	GamePanel gp;
    private BufferedImage[] animatedFrames = new BufferedImage[6];
    private int animatedCounter = 0;
	public static final String objName = "Small Torch";
	
	public OBJ_SmallTorch(GamePanel gp) {
		...
		for (int i = 0; i < animatedFrames.length; i++) {
	        animatedFrames[i] = setup("/animated_object/small_torch_" + i, 1, 1);
	    }
