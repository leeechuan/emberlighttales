...
public class OBJ_Fire_Pit extends Entity{
	
	GamePanel gp;
    private BufferedImage[] animatedFrames = new BufferedImage[6];
    private int animatedCounter = 0;
	public static final String objName = "Fire Pit";
	
	public OBJ_Fire_Pit(GamePanel gp) {
		...
		for (int i = 0; i < animatedFrames.length; i++) {
	        animatedFrames[i] = setup("/animated_object/fire_pit_" + i, 1, 1);
	    }
