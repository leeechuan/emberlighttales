...
public class OBJ_BigTorch extends Entity{
	
	GamePanel gp;
    private BufferedImage[] animatedFrames = new BufferedImage[8];
    private int animatedCounter = 0;
	public static final String objName = "Big Torch";
	
	public OBJ_BigTorch(GamePanel gp) {
		...
		for (int i = 0; i < animatedFrames.length; i++) {
	        animatedFrames[i] = setup("/animated_object/big_torch_" + i, 2, 1);
	    }
