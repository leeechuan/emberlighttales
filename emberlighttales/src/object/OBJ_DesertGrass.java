...
public class OBJ_DesertGrass extends Entity{
	
	GamePanel gp;
    public BufferedImage[] animatedFrames = new BufferedImage[8];
    public int animatedFlower = 0;
	public static final String objName = "Desert Grass";
	
	public OBJ_DesertGrass(GamePanel gp, int grassType) {
		...
		for (int i = 0; i < animatedFrames.length; i++) {
	        animatedFrames[i] = setup("/flora/desert_grass_" + grassType + "_" + i, 1, 1);
	    }
		collision = false;
