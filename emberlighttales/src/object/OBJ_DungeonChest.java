...
public class OBJ_DungeonChest extends Entity{
	...
	public OBJ_DungeonChest(GamePanel gp) {
		...
		type = type_obstacle;
		name = objName;
		frontStanding[0] = setup("/animated_object/dungeon_chest_0", 1, 1);
		frontStanding[1] = setup("/animated_object/dungeon_chest_1", 1, 1);
		frontStanding[2] = setup("/animated_object/dungeon_chest_2", 1, 1);
		frontStanding[3] = setup("/animated_object/dungeon_chest_3", 1, 1);
		frontStanding[4] = setup("/animated_object/dungeon_chest_4", 1, 1);
		frontStanding[5] = setup("/animated_object/dungeon_chest_5", 1, 1);
